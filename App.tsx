...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initData = async () => {
      try {
        ...
        const savedDurations = localStorage.getItem('omni_timer_durations');
        if (savedDurations) {
            try {
  ...
  const handleUpdateDurations = (newDurations: TimerDurations) => {
      ...
      localStorage.setItem('omni_timer_durations', JSON.stringify(newDurations));
  ...
  useEffect(() => {
      ...
      const updatePresence = () => {
          set(userStatusRef, { 
              ...
              currentRevenue: lifetimeTotalMs
          });
      };
  ...
  }, [currentUser, status, dailyTotalMs, elapsedMs, lifetimeTotalMs]);

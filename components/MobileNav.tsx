...
import { Timer, BarChart3, CalendarDays, Settings, BookOpen, Repeat, Home } from 'lucide-react';
import { useTheme } from '../contexts/ThemeContext';

export type MobileTab = 'dashboard' | 'timer' | 'timeline' | 'calendar' | 'settings' | 'journal' | 'habits';
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center w-full h-full gap-1 transition-colors min-w-[4rem] px-2 py-1

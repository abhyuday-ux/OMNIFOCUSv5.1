...
export const TimerDisplay: React.FC<TimerDisplayProps> = ({
  ...
  // Load saved durations on mount and sync
  useEffect(() => {
      const loadDurations = () => {
      ...
      loadDurations();
      window.addEventListener('omni_sync_complete', loadDurations);

      if (!isWallpaperMode) {
          fetchMotivationalQuote();
      }
      
      return () => window.removeEventListener('omni_sync_complete', loadDurations);
  }, [isWallpaperMode]);

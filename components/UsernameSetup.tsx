        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-xl">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    <div className="w-16 h-16 bg-cyan-500/20 rounded-2xl flex items-center justify-center mx-auto mb-6 text-cyan-400 border border-cyan-500/20">
                        <AtSign size={32} />
                    </div>
                    
                    <h2 className="text-2xl font-bold text-white mb-2">Claim Your Handle</h2>
                    <p className="text-slate-400 mb-8">Choose a unique username for the Ekagrazone.</p>

                    <div className="relative mb-6">
                        <input 
                            className={`w-full bg-slate-950 border ${error ? 'border-red-500/50' : isAvailable ? 'border-emerald-500/50' : 'border-white/10'} rounded-xl py-4 pl-12 pr-4 text-white font-mono text-lg focus:outline-none focus:border-cyan-500 transition-colors`}
                    ...
                    <button
                        ...
                        className={`w-full py-4 rounded-xl font-bold text-white transition-all shadow-lg
                            ${isAvailable 
                                ? 'bg-cyan-600 hover:bg-cyan-500 shadow-cyan-500/20 transform hover:-translate-y-0.5' 
